...
For desktop applications where bundle size and startup performance matter, the small convenience of shorter import paths is not worth the significant performance cost.
